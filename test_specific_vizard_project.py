#!/usr/bin/env python3
"""
Test script for downloading highlights from a specific Vizard project ID.
"""
...
def main():
    ...
    # Use a specific project ID that we know exists
    project_id = "23103701"  # Use a raw ID format
    
    print(f"🔍 Testing with specific project ID: {project_id}")
